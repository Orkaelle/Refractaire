...
def train_model (datasetPath, modelName, conv1_layers=32, conv1_kernelsize=3, conv1_activation='relu', conv2_layers=64, conv2_kernelsize=3, conv2_activation='relu', dropout1=0.25, dense_units=128, dense_activation='relu', dropout2=0.5):
	...
	with mlflow.start_run():
		...
		# mlflow.sklearn.log_model(model, "model", registered_model_name="BetterBeforeModel")
